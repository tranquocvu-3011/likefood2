...
export const tracking = {
    ...
    viewItem: (productId: string, productName: string, price: number, category: string) => trackEvent('view_item', {
        items: [{
            item_id: productId,
    ...
    removeFromCart: (productId: string, productName: string, price: number, quantity: number) => trackEvent('remove_from_cart', {
        items: [{
            item_id: productId,
            item_name: productName,
            price,
    ...
    purchase: (orderId: string, totalValue: number, items: TrackingItem[]) => trackEvent('purchase', {
        transaction_id: orderId,
        value: totalValue,
        items
    }),

    selectItem: (productId: string, productName: string, listName: string) => trackEvent('select_item', {
        items: [{
            item_id: productId,
            item_name: productName
        }],
