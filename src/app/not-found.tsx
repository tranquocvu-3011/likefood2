...
export default function NotFound() {
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center bg-slate-50">
            ...
            <h2 className="text-4xl font-black uppercase tracking-tighter mb-4 text-black">Trang không tồn tại!</h2>
            <p className="text-slate-500 mb-12 max-w-md mx-auto text-lg">
                Rất tiếc, đường dẫn bạn đang truy cập không tồn tại hoặc đã bị di dời. Hãy quay lại trang chủ để tiếp tục mua sắm nhé.
            </p>
            <Link
                href="/"
