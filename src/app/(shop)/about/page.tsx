...
export const metadata: Metadata = {
    title: "Về LIKEFOOD - Câu chuyện thương hiệu",
    description: "Khám phá sứ mệnh và giá trị cốt lõi của LIKEFOOD - Mang đặc sản Việt Nam đến người Việt xa xứ tại Hoa Kỳ.",
};

const stats = [
    { icon: MapPin, value: "50+", label: "Làng nghề hợp tác", color: "from-blue-500 to-cyan-500" },
    { icon: Users, value: "10,000+", label: "Khách hàng tin tưởng", color: "from-green-500 to-emerald-500" },
    { icon: Package, value: "500+", label: "Sản phẩm đặc sản", color: "from-orange-500 to-amber-500" },
    { icon: Award, value: "100%", label: "Đạt chuẩn FDA", color: "from-purple-500 to-pink-500" },
];
...
const values = [
    {
        ...
        description: "Tất cả sản phẩm được làm từ nguyên liệu tự nhiên, không chất bảo quản độc hại.",
    },
    {
        icon: Shield,
        title: "An toàn thực phẩm",
        description: "Kiểm định chất lượng nghiêm ngặt theo tiêu chuẩn FDA Hoa Kỳ.",
    },
    {
        icon: Truck,
        title: "Giao hàng toàn Mỹ",
        description: "Ship nhanh đến tất cả 50 bang, đóng gói cẩn thận, giữ nguyên hương vị.",
    },
    {
        icon: Heart,
                ...
                <div className="relative page-container-wide py-20 lg:py-32">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-full mb-6">
                            ...
                            <span className="text-xs font-bold uppercase tracking-widest text-primary">Câu chuyện của chúng tôi</span>
                        </div>
                        ...
                        <p className="text-xl text-slate-500 font-medium leading-relaxed max-w-3xl mx-auto">
                            LIKEFOOD ra đời từ nỗi nhớ hương vị quê hương da diết của những người con Việt tại Mỹ.
                            Chúng tôi tin rằng, mỗi món ăn không chỉ là thực phẩm, mà là một mảnh ký ức, một sợi dây kết nối bền chặt với cội nguồn.
                        </p>
                    </div>
                </div>
            </section>

            {/* Dynamic story from admin (optional) */}
            <AboutDynamicSection />
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                            ...
                            <div className="absolute -bottom-8 -right-8 bg-white rounded-2xl p-6 shadow-2xl max-w-xs hidden lg:block">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-sm font-medium text-slate-500">Sản phẩm đặc sản</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-lg text-slate-500 leading-relaxed mb-8">
                                LIKEFOOD không chỉ bán hàng, chúng tôi kể câu chuyện về những làng nghề truyền thống Việt Nam.
                                Từ đôi bàn tay khéo léo của các nghệ nhân, những sản phẩm tốt nhất được tuyển chọn khắt khe
                                để vượt qua các tiêu chuẩn FDA Hoa Kỳ, mang đến sự an tâm tuyệt đối cho khách hàng.
                            </p>
                            ...
                            <ul className="space-y-4 mb-10">
                                <li className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <span className="font-bold text-slate-900">Kết nối hơn 50 làng nghề truyền thống</span>
                                        <p className="text-sm text-slate-500 mt-1">Từ Châu Đốc, Cà Mau, Phan Thiết đến các vùng miền khác.</p>
                                    </div>
                                </li>
                                <li className="flex items-start gap-4">
                                    <div className="w-8 h-8 bg-primary/10 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                                    ...
                                    <div>
                                        <span className="font-bold text-slate-900">Kiểm định chất lượng 100% tại Mỹ</span>
                                        <p className="text-sm text-slate-500 mt-1">Đạt tiêu chuẩn FDA, đảm bảo an toàn thực phẩm.</p>
                                    </div>
                                </li>
                                <li className="flex items-start gap-4">
                                    <div className="w-8 h-8 bg-primary/10 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                                    ...
                                    <div>
                                        <span className="font-bold text-slate-900">Hỗ trợ cộng đồng người Việt toàn cầu</span>
                                        <p className="text-sm text-slate-500 mt-1">Kết nối và phục vụ hơn 10,000 gia đình Việt tại Mỹ.</p>
                                    </div>
                                </li>
                            </ul>
            ...
            <section className="py-20 bg-gradient-to-r from-primary via-emerald-500 to-cyan-500 relative overflow-hidden">
                ...
                <div className="relative page-container-wide text-center">
                    <h2 className="text-3xl lg:text-5xl font-black uppercase tracking-tighter text-white mb-6">
                        Sẵn sàng thưởng thức đặc sản Việt?
                    </h2>
                    <p className="text-lg text-white/80 max-w-2xl mx-auto mb-10">
                        Đặt hàng ngay hôm nay và nhận ưu đãi đặc biệt dành cho khách hàng mới
                    </p>
                    <Link
                        href="/products"
