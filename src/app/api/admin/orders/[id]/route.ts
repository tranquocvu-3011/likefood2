...
export async function GET(
    ...
    try {
        ...
        logger.error("Order fetch error", error as Error, { context: "admin-orders-api-get", orderId: id });
...
export async function PUT(
    ...
    try {
        ...
        logger.error("Order update error", error as Error, { context: "admin-orders-api-put", orderId: id });
