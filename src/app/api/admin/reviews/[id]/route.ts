...
export async function PATCH(
    ...
    try {
        ...
        logger.error("Admin review moderate error", error as Error, { context: "admin-reviews-patch", reviewId: id });
...
export async function DELETE(
    ...
    try {
        ...
        logger.error("Admin review delete error", error as Error, { context: "admin-reviews-delete", reviewId: id });
