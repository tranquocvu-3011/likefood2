...
export async function PATCH(
    ...
    try {
        ...
        logger.error("Update cart item error", error as Error, { context: "cart-item-patch", itemId: id, userId: session?.user?.id });
        return NextResponse.json(
...
export async function DELETE(
    ...
    try {
        ...
        logger.error("Delete cart item error", error as Error, { context: "cart-item-delete", itemId: id, userId: session?.user?.id });
        return NextResponse.json(
