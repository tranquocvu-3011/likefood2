...
export default function VoucherAndPoints({
    language, selectedVoucher, setSelectedVoucher, setShowVoucherModal,
                ...
                {selectedVoucher ? (
                    ...
                    >
                        ...
                        <span className="text-xs font-bold">
                            {language === "vi" ? "Chọn voucher" : "Select voucher"}
                        </span>
                    </button>
                )}
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className={`font-black text-xs ${usePoints ? "text-amber-900" : "text-slate-500"}`}>
                                        {language === "vi" ? "Dùng LIKEFOOD Xu" : "Use LIKEFOOD Points"}
                                    </p>
                                    <p className="text-[10px] text-slate-400 font-bold">
                                        {language === "vi" ? `Bạn có ${userPoints} Xu` : `You have ${userPoints} Points`}
                                    </p>
                                </div>
                            </div>
                            <button
                            ...
                            >
                                <div className="flex items-center justify-between">
                                    <span className="text-[10px] font-bold text-amber-700">
                                        {language === "vi" ? "Giá trị quy đổi" : "Converted value"}
                                    </span>
