        ...
        >
          ...
          {isOpen && (
            <>
              ...
              >
              <div className="relative shrink-0 overflow-hidden border-b border-slate-200 bg-[linear-gradient(135deg,#f8fafc_0%,#ecfdf5_55%,#dcfce7_100%)] px-4 py-3 sm:px-6">
                <div className="absolute right-0 top-0 h-20 w-20 rounded-full bg-emerald-200/40 blur-2xl" />
                <div className="relative flex items-center gap-3">
                  {/* Logo AI đẹp: avatar gradient + icon */}
                  <div className="relative flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden rounded-full bg-gradient-to-br from-emerald-500 via-teal-500 to-emerald-700 shadow-md ring-2 ring-white">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-xs font-bold tracking-tight text-slate-800">Trợ lý mua hàng</p>
                    <p className="text-[10px] text-slate-500">Gợi ý sản phẩm · Giao hàng · Đơn hàng</p>
                  </div>
              ...
              {isMinimized ? (
                ...
                <>
                    ...
                    <div className="mx-auto flex max-w-3xl flex-wrap gap-2">
                      {SUGGESTED_PROMPTS.map((prompt) => (
                        <button
                          ...
                          className="rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-left text-sm font-medium leading-snug text-slate-600 transition hover:border-emerald-300 hover:bg-emerald-50 hover:text-emerald-700"
                        >
                          {prompt}
                        </button>
                      ))}
                  ...
                  <div ref={scrollRef} className="min-h-0 flex-1 space-y-3 overflow-y-auto bg-slate-50/80 px-4 py-4 sm:px-6">
                    ...
                    {messages.map((message) => {
                      ...
                      return (
                        ...
                        >
                          <div
                            className={`max-w-[85%] rounded-2xl px-4 py-3 shadow-sm sm:max-w-xl ${
                              isModel
                  ...
                  <div className="shrink-0 border-t border-slate-200 bg-white px-4 py-3 sm:px-6">
                    <div className="mx-auto max-w-3xl rounded-xl border border-slate-200 bg-slate-50 p-3 shadow-inner">
                      <textarea
                        ref={textareaRef}
                        value={input}
