...
export default function WhyChooseUs() {
    ...
    const reasons = [
        {
            icon: Award,
            title: language === "vi" ? "100% Chính hãng" : "100% Authentic",
            description: language === "vi" ? "Đặc sản trực tiếp từ Việt Nam, không qua trung gian" : "Specialties direct from Vietnam, no middleman",
        ...
        {
            icon: Shield,
            title: language === "vi" ? "Giao nhanh 2–3 ngày" : "Fast 2–3 Day Delivery",
            description: language === "vi" ? "Giao hàng nhanh chóng trên toàn nước Mỹ" : "Fast delivery across the entire USA",
            gradient: "from-emerald-500 to-green-400",
            glow: "rgba(16,185,129,0.20)",
        },
        {
            icon: Lock,
            title: language === "vi" ? "Thanh toán bảo mật" : "Secure Payment",
            description: language === "vi" ? "Mã hóa SSL 256-bit, bảo vệ thông tin tuyệt đối" : "256-bit SSL encryption, fully protected",
            gradient: "from-violet-500 to-purple-400",
            glow: "rgba(139,92,246,0.20)",
        },
        {
            icon: RotateCcw,
            title: language === "vi" ? "Đổi trả 7 ngày" : "7-Day Returns",
            description: language === "vi" ? "Không hài lòng? Hoàn tiền 100% không điều kiện" : "Not satisfied? 100% refund, no questions asked",
        ...
        },
        {
            ...
            description: language === "vi" ? "Đội ngũ tư vấn luôn sẵn sàng hỗ trợ bạn" : "Our team is always ready to help you",
