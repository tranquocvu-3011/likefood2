...
export default function CategoryShowcase() {
    ...
    const FALLBACK_CATEGORIES = [
        { name: language === "vi" ? "Cá khô" : "Dried Fish", slug: "ca-kho", image: "/cakho.png", productCount: 0 },
        { name: language === "vi" ? "Tôm & Mực khô" : "Dried Shrimp & Squid", slug: "tom-muc-kho", image: "/muckho.png", productCount: 0 },
        { name: language === "vi" ? "Trái cây sấy" : "Dried Fruits", slug: "trai-cay-say", image: "/traicaysay.png", productCount: 0 },
        { name: language === "vi" ? "Trà & Bánh mứt" : "Tea & Sweets", slug: "banh-mut", image: "/mut_traicay.png", productCount: 0 },
        { name: language === "vi" ? "Gia vị Việt" : "Vietnamese Spices", slug: "gia-vi-viet", image: "/giavi.png", productCount: 0 },
    ];
