      ...
      <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
        <div className="relative min-w-0 flex-1">
          ...
          <input
            ...
            className="h-9 w-full rounded-md border border-zinc-700 bg-zinc-900/80 pl-9 pr-8 text-sm font-medium text-zinc-100 outline-none transition focus:border-teal-500 focus:bg-zinc-900 placeholder:text-zinc-600"
          />
          {searchQuery ? (
            <button
              type="button"
        ...
        {children ? (
          <div className="flex flex-wrap items-center gap-2 rounded-md border border-zinc-800 bg-zinc-900/60 px-3 py-2">
