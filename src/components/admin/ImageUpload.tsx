            ...
            >
                ...
                <div className="p-4">
                            ...
                            {isUploading ? (
                                ...
                                <>
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className="text-[10px] text-zinc-600 mt-1">PNG, JPG, WebP · Tối đa 10MB</p>
                                    </div>
                                </>
                            )}
                            <input
                    ...
                    {validUrls.length === 0 && !isUploading && (
                        <div className="flex items-center gap-2 p-3 mt-2 bg-zinc-900/50 rounded-xl border border-zinc-800 text-zinc-500 text-xs font-medium">
