...
const sizeCharts: Record<string, SizeOption[]> = {
    clothing: [
        { size: "S", chest: "86-91 cm", length: "66 cm", sleeve: "60 cm", fit: "Vừa" },
        { size: "M", chest: "91-96 cm", length: "69 cm", sleeve: "62 cm", fit: "Vừa" },
        { size: "L", chest: "96-101 cm", length: "72 cm", sleeve: "64 cm", fit: "Rộng" },
        { size: "XL", chest: "101-106 cm", length: "74 cm", sleeve: "66 cm", fit: "Rộng" },
        { size: "2XL", chest: "106-111 cm", length: "76 cm", sleeve: "68 cm", fit: "Rộng" },
    ],
    shoes: [
        { size: "38", chest: "24 cm", length: "-", sleeve: "-", fit: "Vừa" },
        { size: "39", chest: "24.5 cm", length: "-", sleeve: "-", fit: "Vừa" },
        { size: "40", chest: "25 cm", length: "-", sleeve: "-", fit: "Vừa" },
        { size: "41", chest: "26 cm", length: "-", sleeve: "-", fit: "Rộng" },
        { size: "42", chest: "27 cm", length: "-", sleeve: "-", fit: "Rộng" },
        { size: "43", chest: "28 cm", length: "-", sleeve: "-", fit: "Rộng" },
    ],
    default: [
        { size: "One Size", chest: "Fits all", length: "Standard", sleeve: "-", fit: "Unisex" },
    ],
};
                ...
                <div className="p-6 md:p-8">
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-slate-200">
                                    ...
                                    <th className="text-left py-3 px-4 text-xs font-black uppercase tracking-widest text-slate-400">
                                        {category === "shoes" ? "Chiều dài chân" : "Ngực"}
                                    </th>
                                    {category !== "shoes" && (
                                        <>
                                            <th className="text-left py-3 px-4 text-xs font-black uppercase tracking-widest text-slate-400">
                    ...
                    <Card className="mt-6 rounded-2xl border border-amber-100 bg-amber-50/50">
                        <CardContent className="p-4">
                            <h4 className="font-bold text-amber-800 text-sm mb-2">💡 Mẹo chọn size đúng</h4>
                            <ul className="text-xs text-amber-700 space-y-1">
                                <li>• Đo chính xác cơ thể trước khi chọn size</li>
                                <li>• Nếu giữa 2 size, chọn size lớn hơn</li>
                                <li>• Kiểm tra bảng đo từng bộ phận cơ thể</li>
                                <li>• Size có thể khác nhau giữa các hãng</li>
                            </ul>
                        </CardContent>
                    </Card>
